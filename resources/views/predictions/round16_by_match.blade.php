...
<div class="flex flex-col gap-4 md:flex-row md:items-end md:justify-between"><div><p class="text-xs font-black uppercase tracking-[.2em] text-[#1238ff]">Comparación general</p><h1 class="mt-2 text-3xl font-black text-[#080f2f] md:text-5xl">Octavos de todos</h1></div><div class="flex gap-2"><a href="{{ route('round32.by_match') }}" class="rounded-xl bg-white px-4 py-3 text-sm font-black shadow ring-1 ring-black/5">Dieciseisavos</a><a href="{{ route('round16.index') }}" class="rounded-xl bg-[#080f2f] px-4 py-3 text-sm font-black text-white">Volver</a></div></div>
