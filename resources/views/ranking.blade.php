        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
                ...
                <p class="mt-2 max-w-3xl text-sm font-semibold leading-6 text-[#080f2f]/55 sm:text-base">
                    Puntos de fase de grupos, llaves acertadas y eliminatorias.
                </p>
            </div>
                ...
                <div class="overflow-hidden rounded-3xl border {{ $isCurrentUser ? 'border-[#159447] ring-2 ring-[#159447]/20' : 'border-slate-200' }} bg-white shadow-sm">
                    ...
                    @endif
                        ...
                        <div class="mt-4 grid grid-cols-3 gap-2">
                            ...
                            <div class="rounded-2xl bg-[#e9f8ef] px-3 py-3 text-center">
                                @if($user->can_view_eliminations)
                                    <p class="text-lg font-black text-[#159447]">{{ $user->elimination_points }}</p>
                                @else
                ...
                <table class="min-w-full">
                    <thead class="bg-[#080f2f] text-white">
                        <tr>
                            ...
                            <th class="px-5 py-4 text-center text-xs font-black uppercase">Eliminatorias</th>
                    ...
                    <tbody>
                        @forelse($ranking as $user)
                            ...
                            <tr class="border-b border-slate-100 {{ $isCurrentUser ? 'bg-[#159447]/5' : 'hover:bg-[#f8f9ff]' }}">
                                ...
                                <td class="px-5 py-4 text-center">
                                    @if($user->can_view_eliminations)
                                        <span class="inline-flex rounded-xl bg-[#e9f8ef] px-4 py-2 text-lg font-black text-[#159447]">{{ $user->elimination_points }}</span>
                                    @else
                                        <span class="text-xl font-black text-[#080f2f]/30">—</span>
                                    @endif
                                </td>
                        ...
                        @empty
                            <tr><td colspan="7" class="px-6 py-16 text-center font-black text-[#080f2f]/40">No hay participantes todavía.</td></tr>
                        @endforelse
                    </tbody>
                </table>
            </div>
